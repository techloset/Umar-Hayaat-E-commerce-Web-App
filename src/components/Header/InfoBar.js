...
export default function InfoBar() {
  return (
    ...
    <div className="container textColor">
      ...
      <div className="py-[12px] md:py-[20px] w-full font-normal  text-[0.875rem]  flex items-center justify-between flex-wrap">
       
        <div>
          <div>
            <Link>Need help? Call us: (+98) 0234 456 789</Link>
          </div>
        </div>

        <div className="flex gap-[1.5rem] pr-[0px] mr-[0px]">
          <div className="flex  lg:gap-[0.5rem]">
            <div >
              <svg
              className="w-[1.2rem] h-[1.2rem] shrink-0 "
