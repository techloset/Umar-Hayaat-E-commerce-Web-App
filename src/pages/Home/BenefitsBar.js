...
export default function BenefitsBar() {
  return (
    <div className="bg-[#E2F4FF] flex md:flex-col justify-center md:justify-around  py-[25px] rounded-lg mb-[20px] ">
    ...
    {/* 1 */}
      <div className="flex items-center gap-[15px]">
        ...
        <div>
          <div>
            <h4 className="text-[#003F62] font-bold text-[16px] mb-[2px]">
              Free delivery
            </h4>
          </div>
          <div>
            <p className="text-[#003F62]  text-[13px]">on order above $50,00</p>
          </div>
        </div>
        {/* Text end*/}
      </div>
      ...
      <div className="flex items-center gap-[15px]">
        ...
        <div>
          ...
          <div>
            <p className="text-[#003F62]  text-[13px]">
      ...
      <div className="flex items-center gap-[15px]">
        ...
        <div>
          ...
          <div>
            <p className="text-[#003F62]  text-[13px]">Avaliable warranty</p>
          </div>
        </div>
        {/* Text end*/}
      </div>
